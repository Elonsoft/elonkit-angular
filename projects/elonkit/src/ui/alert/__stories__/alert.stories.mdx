...
<Preview source={ALERT_STORY_ICON_MAPPING_SOURCE}>
  <Story name='Icon mapping' height='400px'>
    {{
      component: AlertStoryIconMappingComponent,
      moduleMetadata: {
        imports: [BrowserAnimationsModule, AlertStoryIconMappingModule]
      }
    }}
  </Story>
</Preview>
...
<Preview source={ALERT_STORY_LOCALE_SOURCE}>
  <Story name='Locale' height='200px'>
    {{
      component: AlertStoryLocaleComponent,
      moduleMetadata: {
        imports: [BrowserAnimationsModule, AlertStoryLocaleModule]
      }
    }}
  </Story>
</Preview>
...
```ts
interface ESAlertDefaultOptions {
  typography?: string;
