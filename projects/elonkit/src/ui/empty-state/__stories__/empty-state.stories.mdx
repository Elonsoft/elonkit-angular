...
<Meta
  ...
  argTypes={{
    icon: {
      control: { type: 'select', options: ['box', 'chat', 'face', 'file', 'lock', 'search'] }
    }
  }}
/>
...
<Canvas source={EMPTY_STATE_STORY_BASIC_SOURCE}>
  <Story name='Basic' height='170px'>
    {((args, context) => ({
      ...
      moduleMetadata: {
        imports: [HttpClientModule, ESCoreModule, ESEmptyStateModule]
      },
      props: {
        ...args,
...
<Canvas source={EMPTY_STATE_STORY_BUTTON_SOURCE}>
  <Story name='Button' height='200px'>
    {((args, context) => ({
      ...
      `,
      moduleMetadata: {
        imports: [HttpClientModule, MatButtonModule, ESCoreModule, ESEmptyStateModule]
      },
      props: {
        ...args,
        heading: getHeading(args, context),
