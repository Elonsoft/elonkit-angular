...
<Preview source={IMAGE_CAROUSEL_STORY_CUSTOM_ICON_SOURCE}>
  <Story name='Custom Icon' height='200px'>
    {{
      component: ImageCarouselStoryCustomIconComponent,
      moduleMetadata: {
        imports: [BrowserAnimationsModule, ImageCarouselStoryCustomIconModule]
      }
    }}
  </Story>
</Preview>
...
<Preview source={IMAGE_CAROUSEL_STORY_LOCALE_SOURCE}>
  <Story name='Locale' height='200px'>
    {{
      component: ImageCarouselStoryLocaleComponent,
      moduleMetadata: {
        imports: [BrowserAnimationsModule, ImageCarouselStoryLocaleModule]
      }
    }}
  </Story>
</Preview>
