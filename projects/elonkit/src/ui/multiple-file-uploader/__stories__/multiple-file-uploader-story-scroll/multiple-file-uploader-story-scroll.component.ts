...
@Component({
  selector: 'es-multiple-file-uploader-scroll',
  templateUrl: './multiple-file-uploader-story-scroll.component.html',
  styleUrls: ['./multiple-file-uploader-story-scroll.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MultipleFileUploaderStoryScrollComponent {
  @Output()
